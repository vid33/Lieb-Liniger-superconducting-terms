...
function [ t_c ] = findOverlapZero( R, K, deltaR, deltaK, matr_init, r_zero, F_zero, Rtangent_orig, D, mass, uu, potential, interaction,...
    ...
    while 1
        ...
        realOverlap = (1/normRtangent_init)*real(trace(Rtangent_r*matr_r*Rtangent_orig'));
    ...
    while 1
        ...
        realOverlap_c = (1/normRtangent_init)*real(trace(Rtangent_c*matr_c*Rtangent_orig'));
