fprintf('%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%\n');
        fprintf('D = %d, uu = %d, v = %d, c = %d \n', D, uu, potential, interaction);
        fprintf('AT STEP %d\n', currentStep);
        ...
        fprintf('Total energy density is %6.16e \n' ,energyDensity_new );
       % fprintf('Energy density ignoring chemical pot. %d\n' , (energyDensity_new - ePotDensity) );
        ...
        fprintf('Min svd(matr) is %6.10e \n', min(svd(matr)));
        fprintf('Trace(R) is %6.10e \n', trace(R+R'));
        fprintf('norm(trace(R*matr)) is %6.10e \n', norm(trace(R*matr)));
        fprintf('%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%\n');   
  ...
  %      fprintf('Initial norm is %d \n', initial_norm);
       ...
       % fprintf('determinant of R is %d \n', det(R));
       %  fprintf('determinant of K is %d \n', det(K));
       %  fprintf('determinant of Q is %d \n', det(Q));
       % fprintf('determinant of matr is %d \n', det(matr));
