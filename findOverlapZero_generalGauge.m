...
function [ t_c ] = findOverlapZero_symmetricGauge( R, K, deltaR, deltaK, matr_init, matl_init, r_zero, F_zero, Rtangent_orig, D, mass, potential, uu, interaction,...
    ...
    Rtangent_init = real(trace(matl_t*deltaR*matr_init*deltaR'));
    ...
    while 1
        ...
        Rtangent_r = (matl_t\transpose(matF_r)*R_r)-R_r*(matl_t\transpose(matF_r))...
        ...
        realOverlap = (1/Rtangent_init)*real(trace(matl_t*Rtangent_r*matr_r*Rtangent_orig'));
    ...
    while 1
        ...
        realOverlap_c = (1/Rtangent_init)*real(trace(matl_t*Rtangent_c*matr_c*Rtangent_orig'));
